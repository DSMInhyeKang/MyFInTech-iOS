...
class SavingsViewModel: BaseViewModel {
    ...
    let descriptions = BehaviorRelay<[Descriptions]>(value: [
        ...
        Descriptions(
            ...
            청년도약계좌
             : 만 19세~34세 이하의 청년 전용 상품이에요.
               개인소득요건, 가구소득요건을 모두 충족해야
               가입이 가능해요.
            """,
    ...
    let attachedURL = "https://benevolent-grace.notion.site/f0179c0cfc2e4019a9d5b1fdf6c0015f?pvs=4"
